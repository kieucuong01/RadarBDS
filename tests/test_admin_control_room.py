...
class AdminControlRoomGateTest(unittest.TestCase):
    ...
    def test_admin_duplicate_review_ui_explains_the_decision(self):
        ...
        self.assertIn("function showDupGroupPairs", js)
        self.assertIn("duplicatePairModeGroups", js)
        self.assertIn("/admin/api/qc/duplicates/merge-bulk", js)
        self.assertIn("dup-group-source-links", js)
        self.assertIn("Tách tin này", js)
        ...
        self.assertIn(".dup-group-source-links", css)
        self.assertIn(".dup-decision-copy", css)
        self.assertIn("admin-v43-dup-cluster-pairs", template)
