...
class ValuationToolTest(unittest.TestCase):
    ...
    def test_guest_can_view_page_and_gets_basic_result(self):
        ...
        self.assertIn("valuation-comparable-cards-20260728", html)
        ...
        self.assertLessEqual(len(payload["comparables"]), 6)
        self.assertTrue(payload["comparables"])
        self.assertTrue(all(item["detail_href"].startswith("/listing/") for item in payload["comparables"]))
