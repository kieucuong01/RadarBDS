...
assert.match(source, /brokerCell\('Vận hành', 'crawl-broker-ops'\)/);
assert.match(source, /brokerCell\('Kế hoạch', 'crawl-broker-plan'\)/);
assert.match(source, /crawl-broker-city-chip/);
assert.match(source, /urlNode\.className = 'crawl-broker-url'/);
assert.match(source, /brokerName\.className = 'crawl-broker-name'/);
assert.match(source, /cell\.colSpan = 6/);
