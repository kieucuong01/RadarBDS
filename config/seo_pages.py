...
SEO_PAGES = {
    "binh-duong": {
        "variant": "market",
        "path": "/binh-duong",
        "title": "Radar BDS Bình Dương - Săn deal nhà đất Bình Dương bằng dữ liệu",
        "description": (
            "Radar BDS thu thập, chuẩn hóa và phân tích tin rao nhà đất Bình Dương để tìm bất động sản "
            "có giá tốt hơn thị trường và biên an toàn rõ ràng."
        ),
        "keywords": (
            "Radar BDS, nhà đất Bình Dương, bất động sản Bình Dương, săn deal nhà đất, "
            "định giá bất động sản, margin of safety BDS"
        ),
        "hero_badge": "Bình Dương - Dữ liệu thật - Deal chất",
        "hero_title": "Săn deal nhà đất Bình Dương bằng dữ liệu",
        "hero_text": (
            "Radar BDS thu thập và chuẩn hóa hàng ngàn tin rao mỗi ngày, phân tích - định giá - "
            "so sánh để tìm ra những bất động sản có giá tốt hơn thị trường và biên an toàn cao."
        ),
