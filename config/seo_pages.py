...
SEO_PAGES = {
    ...
    "bao-cao/bds-binh-duong-thang-06-2026": {
        ...
        "description": (
            "Báo cáo thị trường BĐS Bình Dương tháng 06/2026 từ Radar BDS: bản cập nhật hiện tại "
            "chỉ tập trung các phường Thủ Dầu Một có dữ liệu đủ dày để so giá và lọc tín hiệu."
        ),
        "keywords": (
            "báo cáo thị trường BĐS Bình Dương, báo cáo Thủ Dầu Một, thị trường bất động sản Bình Dương tháng 06 2026, "
            "giá đất Thủ Dầu Một, Radar BDS"
        ),
        "hero_badge": "Báo cáo thị trường - Cập nhật 24/06/2026",
        "hero_title": "Báo cáo thị trường BĐS Bình Dương tháng 06/2026",
        "hero_text": (
            "Bản cập nhật hiện tại của Radar BDS chỉ tập trung các phường Thủ Dầu Một vì đây là nhóm "
            "đang có dữ liệu đủ dày để so giá, đọc nguồn cung và lọc tín hiệu đáng kiểm tra."
        ),
        "hero_checks": ["Các phường Thủ Dầu Một", "6.596 tin đang theo dõi", "Giá/m² trung vị 25.9"],
        "primary_cta": "Mở dashboard Radar BDS",
        "secondary_cta": "Xem hub Bình Dương",
        "secondary_href": "/binh-duong",
        "map_label": "Report / Thu Dau Mot snapshot",
        "hero_metric": {
            "label": "Phạm vi báo cáo",
            "value": "13",
            "delta": "phường",
            "note": "chỉ lấy các phường Thủ Dầu Một đủ dày dữ liệu",
        },
        "property_card": {
            "status": "Market report",
            "title": "Thủ Dầu Một - snapshot dữ liệu hiện tại",
            "price": "Nguồn: active listings + định giá + actionable signal",
            "metric_a": "Giá/m²",
            "metric_a_value": "trung vị",
            "metric_b": "Tín hiệu",
            "metric_b_value": "theo phường",
        },
        "value_cards": [
            {
                "title": "Chỉ dùng phạm vi đủ dày dữ liệu",
                "body": "Trang này tạm thu hẹp về các phường Thủ Dầu Một để tránh so chéo với những khu khác chưa đủ dày dữ liệu công khai ở thời điểm hiện tại.",
            },
            {
                "title": "Đọc theo phường thay vì đọc cả thành phố",
                "body": "Snapshot hiện tại cho thấy chênh lệch giá/m² giữa từng phường Thủ Dầu Một khá lớn, nên người mua cần lọc theo ward trước khi kết luận rẻ hay đắt.",
            },
            {
                "title": "Dùng số liệu hiện tại để mở dashboard đúng chỗ",
                "body": "Thay vì nói chung chung về Bình Dương, báo cáo này chỉ ra phường nào đang có nguồn cung dày, phường nào có nhiều tín hiệu, và phường nào cần lọc kỹ giá.",
            },
        ],
        "report": {
            "period": "Cập nhật hiện tại - 24/06/2026",
            "published_at": "2026-06-24",
            "updated_label": "Cập nhật 24/06/2026",
            "source_note": "Nguồn: active listings hiện tại, lịch sử giá và latest valuation của Radar BDS; bản public này chỉ tập trung các phường Thủ Dầu Một đủ dày dữ liệu.",
            "metrics": [
                {
                    "label": "Tin đang theo dõi",
                    "value": "6.596",
                    "note": "active listings thuộc các phường Thủ Dầu Một, đã loại sold, blacklist, hidden và duplicate",
                },
                {
                    "label": "Giá/m² trung vị",
                    "value": "25.9 tr/m²",
                    "note": "tính trên các tin có diện tích và giá đủ rõ trong snapshot hiện tại",
                },
                {
                    "label": "Phường điều chỉnh giá",
                    "value": "Phú Mỹ",
                    "note": "đang có 3 tin active mang cờ price drop trong snapshot hiện tại",
                },
                {
                    "label": "Phường nhiều tín hiệu",
                    "value": "Phú Mỹ · Hiệp An",
                    "note": "hai phường đang đồng dẫn đầu với 32 actionable signals mỗi phường",
                },
            ],
            "area_rows": [
                {
                    "area": "Phú Mỹ",
                    "new_listings": "983 tin",
                    "median_price": "29.7 tr/m²",
                    "drop_signal": "3 tin giảm giá",
                    "radar_signal": "Nguồn cung dày nhất và đồng dẫn đầu actionable signals",
                },
                {
                    "area": "Hiệp An",
                    "new_listings": "320 tin",
                    "median_price": "18.1 tr/m²",
                    "drop_signal": "2 tin giảm giá",
                    "radar_signal": "Đồng dẫn đầu actionable signals, hợp để lọc tiếp theo MOS và giá/m²",
                },
                {
                    "area": "Hiệp Thành",
                    "new_listings": "608 tin",
                    "median_price": "31.3 tr/m²",
                    "drop_signal": "0 tin giảm giá",
                    "radar_signal": "29 actionable signals dù không dựa vào price drop, cần đọc theo phân khúc",
                },
                {
                    "area": "Định Hòa",
                    "new_listings": "691 tin",
                    "median_price": "18.3 tr/m²",
                    "drop_signal": "2 tin giảm giá",
                    "radar_signal": "Mặt bằng thấp hơn rõ so với lõi trung tâm, cần so đúng phường trước khi kết luận rẻ",
                },
                {
                    "area": "Tương Bình Hiệp",
                    "new_listings": "687 tin",
                    "median_price": "19.2 tr/m²",
                    "drop_signal": "0 tin giảm giá",
                    "radar_signal": "22 actionable signals, phù hợp theo dõi nhóm đất dân cư và đất vườn tách phường",
                },
            ],
            "insights": [
                {
                    "title": "Nhận định từ dữ liệu Radar",
                    "body": "Bản cập nhật public hiện tại chỉ tập trung các phường Thủ Dầu Một. Đây là phạm vi đủ dày dữ liệu để so giá theo ward, tránh dùng số tổng Bình Dương khi các khu khác chưa ổn định cho một snapshot công khai.",
                },
                {
                    "title": "Phường nên mở trước trên dashboard",
                    "body": "Phú Mỹ đang có nguồn cung active lớn nhất và đồng dẫn đầu số actionable signals với Hiệp An. Nếu cần mở dashboard từ một điểm bắt đầu hữu ích, đây là hai phường đáng lọc trước.",
                },
                {
                    "title": "Đừng so chéo giá giữa các phường Thủ Dầu Một",
                    "body": "Định Hòa và Tương Bình Hiệp đang có trung vị quanh 18-19 tr/m², trong khi Phú Lợi, Chánh Nghĩa, Hiệp Thành hay Phú Mỹ cao hơn đáng kể. Cùng là Thủ Dầu Một nhưng phải so đúng phường rồi mới đọc MOS.",
                },
            ],
            "methodology": [
                "Chỉ giữ active listings thuộc các phường Thủ Dầu Một; không dùng các khu khác cho bản public hiện tại.",
                "Loại sold, blacklist, review hidden và duplicate trước khi tính snapshot.",
                "Giá/m² trung vị được dùng để giảm ảnh hưởng của các tin quá cao hoặc quá thấp bất thường.",
                "Tín hiệu dùng latest valuation cộng actionable signal gate, không đọc raw is_signal đơn lẻ.",
                "MOS và price drop là tín hiệu ưu tiên kiểm tra, không thay thế thẩm định pháp lý, quy hoạch hoặc hiện trạng.",
            ],
        },
        "process_title": "Cách đọc báo cáo thị trường Radar BDS",
        "process": [
            {
                "title": "1. Xem phường nào đang đủ dày dữ liệu",
                "body": "Bắt đầu từ các phường Thủ Dầu Một có nguồn hàng active lớn để biết nơi nào đáng mở trước trên dashboard.",
            },
            {
                "title": "2. So giá/m² theo từng phường",
                "body": "Dùng giá/m² trung vị làm mốc tham chiếu rồi so tiếp theo diện tích, loại tài sản và vị trí trong từng phường.",
            },
            {
                "title": "3. Kiểm tra price drop nhưng không lệ thuộc hoàn toàn",
                "body": "Phường có price drop đáng chú ý là nơi nên kiểm tra lịch sử giá trước, nhưng phường nhiều tín hiệu không nhất thiết phải có nhiều giá giảm.",
            },
            {
                "title": "4. Ưu tiên phường nhiều actionable signals",
                "body": "Mở dashboard để lọc tiếp các phường đang có nhiều actionable signals theo MOS, thổ cư, diện tích và giá/m².",
            },
            {
                "title": "5. Xác minh ngoài thực địa",
                "body": "Báo cáo này là lớp lọc dữ liệu ban đầu; pháp lý, quy hoạch, hiện trạng và vị trí thực tế vẫn cần kiểm tra riêng.",
            },
        ],
        "faq": [
            {
                "q": "Báo cáo thị trường BĐS Bình Dương này dùng dữ liệu nào?",
                "a": "Báo cáo dùng dữ liệu crawl, chuẩn hóa vị trí, lịch sử giá và kết quả định giá nội bộ của Radar BDS trong kỳ theo dõi.",
            },
            {
                "q": "Giá/m² trung vị có phải giá giao dịch không?",
                "a": "Không. Đây là mốc tham chiếu từ tin rao đủ dữ liệu, dùng để lọc cơ hội trước khi xác minh giao dịch và pháp lý.",
            },
            {
                "q": "Vì sao báo cáo tách khu giảm giá và khu nhiều tín hiệu?",
                "a": "Khu giảm giá giúp tìm nơi có biến động, còn khu nhiều tín hiệu giúp ưu tiên nơi có nguồn dữ liệu đủ dày để so MOS đáng tin hơn.",
            },
            {
                "q": "Bao lâu Radar BDS nên cập nhật báo cáo thị trường?",
                "a": "Nên cập nhật theo tháng, hoặc sớm hơn khi có biến động nguồn cung, giá/m² trung vị hoặc số tín hiệu MOS thay đổi rõ.",
            },
        ],
        "final_cta": {
            "title": "Muốn xem dữ liệu phía sau báo cáo?",
        ...
        "local_links": [
            ...
            },
            {
                ...
                "href": "/binh-duong",
                "description": "Hub chính cho bất động sản Bình Dương và dữ liệu thị trường.",
            },
            {
                "label": "Bán đất Bình Dương",
                "href": "/ban-dat-binh-duong",
                "description": "Landing riêng cho đất nền, đất thổ cư và giá/m².",
            },
            {
                "label": "Thủ Dầu Một",
                "href": "/binh-duong/thu-dau-mot",
                "description": "Trang khu vực tập trung vào các phường Thủ Dầu Một và cách lọc theo ward.",
            },
        ],
    },
    "san-deal-bds": {
