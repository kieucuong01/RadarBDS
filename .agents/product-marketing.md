...
**Decision-makers:** The buyer or investor making the viewing/offer decision; for small investor groups, the person sourcing and screening opportunities.
...
**Core problem:** Bình Dương property buyers waste time reading noisy, duplicated, incomplete, or misleading listings before they can identify a small number of opportunities worth checking.

**Why alternatives fall short:**
- Generic portals show listings but do not prioritize local MOS or source quality.
- Facebook groups are fast but noisy, duplicated, and full of vague price/location claims.
- Manual spreadsheets become stale and do not alert users when a saved target area changes.

**What it costs them:** Missed opportunities, wasted calls, wasted site visits, false confidence in bait prices, and slower reaction to genuinely cheap listings.
...
**Why that's better:** Users get fewer but more actionable leads, with context that helps them decide what to inspect first.

**Why customers choose us:** They want a practical first-pass filter for Bình Dương deals, not another raw listing feed.
...
**Anxiety:** Users may worry the model is wrong, the data is stale, or a signal is not enough to justify action. Messaging must keep verification and due diligence explicit.

## Customer Language
**How they describe the problem:**
- "Tin rẻ chưa chắc là deal."
- "Không biết khu này giá bao nhiêu là hợp lý."
- "Facebook nhiều tin quá, không biết tin nào đáng gọi."
- "Sợ bị mồi giá hoặc sai vị trí."
...
| Term | Meaning |
|------|---------|
| MOS | Margin of safety, the gap between estimated fair value and asking price |
| Fair value | Internal estimate from comparable local listing data |
| Watchlist | Saved target criteria for areas, property type, price, area, and MOS |
| Source quality | Warnings about extraction, price, location, source, or listing reliability |

## Brand Voice
**Tone:** Practical, data-backed, cautious, locally fluent.

**Style:** Direct Vietnamese with clear caveats; short explanations before asking users to act.
...
**Testimonials:**
> Use real user quotes only after collected.
