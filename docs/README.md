...
| Browser-use social ops, Facebook group assist, broker discovery, social trend monitoring | `browser-use-social-ops.md` | Browser-use venv/profile under `/home/hermesops/radar-browser-use/`, future `data/social_*` queues, social scripts |
