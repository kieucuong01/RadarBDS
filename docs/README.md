...
| Browser-use social ops, Facebook Page/group assist, broker discovery, social trend monitoring, social queue | `browser-use-social-ops.md`, `social-care-workflow.md` | `scripts/radar_social_queue.py`, `scripts/browser_use_page_post.py`, `scripts/radar_social_auto_post.py`, browser-use venv/profile under `/home/hermesops/radar-browser-use/` |
