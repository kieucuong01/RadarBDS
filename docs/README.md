...
| Daily SEO article publishing, `/tin-tuc`, @rb daily cron | `daily_seo_publisher.md`, `growth_marketing_workflow.md` | `scripts/radar_daily_seo_context.py`, `config/seo_articles.py`, `app.py`, `routes/public.py`, `templates/seo_article.html`, `tests/test_public_seo.py` |
