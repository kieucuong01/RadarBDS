...
| Homepage/filter performance, burst load, cache/read-model scaling | `superpowers/specs/2026-08-01-homepage-filter-performance-scale-design.md`, `architecture.md`, `product_rules.md`, `operations.md`, `dev_commands.md` | `services/market_data.py`, `db/connection.py`, `routes/*`, `app.py`, `deployment/ubuntu24/*` |
