...
| Homepage/filter performance, burst load, cache/read-model scaling | `superpowers/specs/2026-08-01-homepage-filter-performance-scale-design.md`, `superpowers/plans/2026-08-01-homepage-performance-scale-master.md`, `architecture.md`, `product_rules.md`, `operations.md`, `dev_commands.md` | `services/market_data.py`, `db/connection.py`, `routes/*`, `app.py`, `deployment/ubuntu24/*` |
