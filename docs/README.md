...
|---|---|---|
| Growth marketing, marketing skills, SEO strategy, CRO, Hermes daily marketing, analytics loops | `growth_marketing_workflow.md`, `seo_geo_lead_baseline.md`, `hermes_marketing_workflow.md`, relevant `.agents/skills/<skill>/SKILL.md` | `.agents/product-marketing.md`, `.agents/skills/*`, `.agents/loops/*`, `docs/daily_seo_publisher.md`, public SEO files |
...
| Listing Maps registry, browser evidence, map-location backfill | `listing_map_registry_automation.md`, `dev_commands.md`, `operations.md` | `services/listing_location_*`, `config/listing_map*`, `static/maps/listing-locations/*` |
...
| Homepage/filter performance, CDN, burst load, cache/read-model scaling | `superpowers/specs/2026-08-01-homepage-filter-performance-scale-design.md`, `superpowers/specs/2026-08-01-cloudflare-origin-shield-design.md`, `superpowers/plans/2026-08-01-homepage-performance-scale-master.md`, `superpowers/plans/2026-08-01-cloudflare-origin-shield.md`, `architecture.md`, `product_rules.md`, `operations.md`, `dev_commands.md` | `services/market_data.py`, `db/connection.py`, `routes/*`, `app.py`, `deployment/ubuntu24/*`, `scripts/load/*`, `scripts/verify_public_cache.ps1` |
